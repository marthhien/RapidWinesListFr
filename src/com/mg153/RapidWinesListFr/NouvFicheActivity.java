...
public class NouvFicheActivity extends Activity {
	...
	/*  	String text1 = "Nom du vin";
		...
		Vin stud = VinDBoperation.addVin(text1,text4,text4,text4,text4,text4,text2,text3,text4,text4,text4,1,text4); */
     	...
     	Toast.makeText(NouvFicheActivity.this, "Ajouté", Toast.LENGTH_SHORT).show(); 
	    ...
	    switch (requestCode) {
	        case TAKE_PICTURE:
	            if (resultCode == Activity.RESULT_OK) {
	                ...
	                imgPath = nomunique;
	        		Toast.makeText(NouvFicheActivity.this, "Enregistrement de la photo ...", Toast.LENGTH_LONG).show();  }
        		else {
        			imgPath = nomunique2;
	        }
	    }
